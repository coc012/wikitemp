...
![](https://user-gold-cdn.xitu.io/2017/11/22/15fe1ee0e2cc90e9?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2017/11/22/15fe1ee0dfd781e7?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
使用 `git diff HEAD` 可以显示工作目录和上一条提交之间的不同，它是上面这二者的内容相加。换句话说，这条指令可以让你看到「如果你现在把所有文件都 `add` 然后 `git commit`，你将会提交什么」。
